...
Dans Solaires, les personnages n'ont pas de caractéristiques communes définies, comme vous pouvez avoir l'habitude de voir dans d'autres jeux de rôles. Le Système Féerie qui motorise le jeu dispose d'une structure beaucoup plus libre. Ainsi, pour fonctionner avec les règles du jeu, un personnage de Solaires est principalement défini par des éléments.
...
**Les traits** sont donc les traits de caractère et ses points particuliers, physiques comme mentaux. Pour les évaluer, utilisez la correspondance suivante :
