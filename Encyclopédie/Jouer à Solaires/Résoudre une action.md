...
Précisons que nous vous déconseillons une action dont l’un des résultats serait : « Rien ne se passe ! ». Évitez autant que possible de maintenir le statu quo d’une situation après une action : qu’une action réussit ou qu’elle échoue, il doit se passer quelque chose !
...
*Exemple, Razors fait face au grand antagoniste de la série qui menace de causer de grands dégâts. Sophie souhaite que son personnage combatte pour le mettre hors d’état de nuire. Après que Justine, la meneuse, ait indiqué la difficulté, la joueuse s’exclame : « Je me moque de survivre, je veux être sûre de l’avoir ! ». La meneuse lui explique alors qu’elle abaisse la difficulté, mais que si Sophie ne conserve pas les trois dés, Razors sera mise hors service. La joueuse accepte.*

## Difficulté

Le meneur évalue ensuite la difficulté de l’action. Pour y parvenir, il peut se servir de deux échelles de difficulté, l’une évaluant la difficulté intrinsèque de l’action, l’autre son intérêt pour l’histoire. Pour obtenir la difficulté finale, il fait la somme de ses choix sur ces deux échelles.

>> Note : si vous hésitez entre deux niveaux de difficulté sur l'une de ces échelles, prenez la valeur intermédiaire.

La difficulté intrinsèque représente la difficulté « objective » dans l’univers de jeu. Elle ne doit pas être estimée en fonction des compétences ou capacités du personnage, mais de façon absolue. Il peut toutefois être nécessaire de tenir compte de la façon dont compte s’y prendre le personnage si indiqué.
...
Notez que si le meneur juge une action impossible (ou triviale), il ne fait pas faire un jet de dés : l’action échoue (ou réussit) automatiquement sans effet secondaire. Ce sera aussi le cas si le score à battre par le joueur est supérieur à 5 ou inférieur à 1.
...
Une fois la difficulté établie, vous devez choisir un élément de votre personnage. Les éléments sont tout ce qui possède un score sur la fiche du personnage, que ce soit un trait, du matériel, etc. L’élément choisi doit avoir, en toute logique, un impact sur l’action.
...
* **Actions communes** : dans de nombreux cas, le groupe de personnage veut effectuer une action qui doit être réussie par tous les personnages. *Par exemple, escalader une falaise, contourner une patrouille furtivement, garder son sang-froid dans une situation critique, etc.* Pour ce type de jet, nous vous proposons de faire faire un jet à chaque personnage. Si la majorité réussit l’action, le groupe réussi. Sinon, le groupe échoue et l’un des personnages dévisse, se fait repérer, panique, etc. Le meneur devrait choisir de préférence celui dont l’échec entraînera la situation la plus intéressante parmi les personnages qui ont échoué le jet.
...
Pour préciser ce qui va se passer, Justine explique que s’ils réussissent, ils pourront effectuer des recherches sur le chantier, mais que s’ils échouent, la sécurité et leur suspect seront prévenus de l'intrusion et risquent d’envoyer des agents. Sophie, l'initiatrice, accepte.
...
Comme pour la résolution des actions, le jet utilisera les trois dés comparés à un score donné. Ici, la détermination du score à battre est très simple :
...
S’il reste au moins deux dés, le résultat sera favorable aux personnages joueurs, sinon, il leur sera défavorable.

*Exemple, une bataille spatiale entre des forces de Suan et Waylanders fait rage à l’extérieur, ce pendant que les personnages joueurs tentent de démêler la situation diplomatique. Le meneur souhaite savoir quel sens la bataille prend. Il utilise donc cette règle et choisi un score de 3, n’ayant pas d’envie scénaristique particulière. Il lance les dés et fait 4, 3 et 1 : il reste deux dés. Comme les personnages joueurs sont en meilleurs termes avec Suan, la bataille commence donc à tourner en faveur de Suan et l’un des vaisseaux de Waylanders a été sévèrement touché.*
...
*Par exemple, si Thalos attaque Lyra et que cette dernière utilise Art-Martiaux (3) et Agile (2), l’action de Thalos se fera contre une difficulté de -2. Les joueurs et le meneur peuvent ensuite décider que si Thalos réussi, il blesse ou neutralise Lyra et qu’en revanche, s’il échoue, c’est Lyra qui blesse ou neutralise Thalos.*
