...
Notez que les installations possèdent un cycle de vie, et si ces cycles ne peuvent être synchronisés à l’échelle du système solaire, c’est le cas au sein d’un même système planétaire. Ainsi, toutes les colonies des lunes de Jupiter utilisent le même cycle horaire de 24 heures. Il en est de même pour les lunes de Saturne bien qu’elles utilisent un autre cycle, lui aussi de 24 heures.
...
La plupart des solaires sont directement connectés au réseau, que ce soit nativement pour les cybernétiques, par un implant pour les cyborgs ou par le traditionnel link.
...
Il existe toutefois des logiciels, les constructs, qui permettent de donner l’illusion d’une conversation lors de tels échanges asynchrones. Ces constructs sont des IA de conversation qui endossent l’avatar de l’expéditeur et une partie de ses habitudes et délivrent leur message sous la forme d’une conversation. Ils sont ensuite capables de fournir une réponse sous une forme synthétique ou transmise via le construct de l’interlocuteur.
